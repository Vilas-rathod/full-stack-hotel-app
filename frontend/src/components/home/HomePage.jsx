        ...
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    <img src="./assets/images/hotel.webp" alt="HotelSilver9" className="header-image" />
            ...
            <h2 className="home-services">Services at <span className="phegon-color">Hotel Silver9</span></h2>
